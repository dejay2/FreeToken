...
void launch_tile(const Tensor& x, const Weight& weight, Tensor& out, cudaStream_t stream) {
    using Schedule =
        W8SmallTMmaSchedule<Capacity == 24 ? 8 : 4, Capacity, 2, W8SmallTMmaScaleAccess::Shared>;
    ...
    w8_small_t_mma_kernel<Geometry, Capacity, Schedule, W8ContiguousOutput, W8SwiGluDirectEpilogue,
