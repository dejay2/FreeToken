    ...
    *,
    ...
    if convert_nvfp4_quasar.matches_config(config):
        return convert_nvfp4_quasar.convert(
            official_dir, quantized_dir, dflash2_model_dir, out_path, device=device
        )
    return _convert_mixed(official_dir, quantized_dir, dflash2_model_dir, out_path, device=device)
