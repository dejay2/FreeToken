...
Use the selected Python 3.11 interpreter explicitly. The default shell's `python3` may be a
different version. Use it only after selecting the maintainer environment or checking its version.
