...
XOR/multiply/remainder/offset loop) is ~50 tiny CUDA kernels per decode step, 1.6 ms of launch
wall for 0.05 ms of GPU work. This is the same arithmetic as one kernel, one program per token.
