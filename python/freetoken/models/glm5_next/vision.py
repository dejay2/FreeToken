...
class Glm5NextVisionBlock(BaseOP):
    def __init__(self, vc: VisionConfig):
        ...
        self.mlp = Glm5NextGatedMLP(vc.hidden_size, vc.intermediate_size, swiglu_limit=vc.swiglu_limit, has_bias=vc.attention_bias)
...
class Glm5NextVisionPatchMerger(Glm5NextGatedMLP):
    ...
    def __init__(self, vc: VisionConfig):
        super().__init__(vc.out_hidden_size, vc.projection_intermediate_size, swiglu_limit=vc.swiglu_limit)
